...
- **Have to** = external rules/laws
    ...
    exercises: [
      ...
      { id: 'mod-9', type: 'multiple-choice', question: 'You ___ finish the report today. The deadline is tomorrow.', options: ['must', `don't have to`, `must't`, `shouldn't`], correctAnswer: `don't have to`, explanation: `No necessity → don't have to (the deadline is tomorrow, not today).` },
